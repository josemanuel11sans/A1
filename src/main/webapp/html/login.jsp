...
<div class="container-fluid  d-flex align-items-center login-column justify-content-center" id="aaa">
    ...
    <div class="login-container">
        ...
        <!-- formulario de login -->
        <form class="login-form" id="loginForm" onsubmit="return validarDatos(event)">

            <div class="form-group align-items-center">
                <p></p>
                <label for="username" style="color: #fff;">usar "root" como user y password</label>
                <div class="input-container">
                    <i class="fas fa-user " style="color: #003366;"></i>
                    <input type="text" id="username" class="form-control" placeholder="Correo electronico" required>
                </div>
            </div>
